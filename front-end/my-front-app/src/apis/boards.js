...
export const insert = (formData, headers) => axios.post("/boards", formData, headers ) // 파일 관련 api

// 수정
// export const update = (id, title, writer, content) => axios.put("/boards", {id, title, writer, content} ) -> 기존 게시판 수정 api
export const update = (formData, headers) => axios.put("/boards", formData, headers ) // 파일 관련 api
